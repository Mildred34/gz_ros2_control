...
#ifndef U_GZ_ROS2_CONTROL__GZ_SYSTEM_INTERFACE_HPP_
#define U_GZ_ROS2_CONTROL__GZ_SYSTEM_INTERFACE_HPP_
...
class UnderactuatedGazeboSimSystemInterface
...
public:
  ...
  enum ControlMethod_
  {
    ...
    // JOINT_VELOCITY  = (1 << 1),
    // JOINT_EFFORT    = (1 << 2),
    // ACTUATOR_POSITION = (1 << 3),
    // ACTUATOR_VELOCITY = (1 << 4),
    // ACTUATOR_EFFORT = (1 << 5)
  };
...
#endif  // U_GZ_ROS2_CONTROL__GZ_SYSTEM_INTERFACE_HPP_
